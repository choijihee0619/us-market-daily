...
| **세션 갭** | **4건** (08-03·08-10·08-17·08-24). **원인 확정: 월요일 수익률 NaN 버그.** 코드·가격은 복구, 세션 재실행은 판단 대기. 7장 16번 |
...
16. **세션 누락 감지·복구.** 설계 완료, 구현 없음 → `docs/SESSION_GAPS.md`.
    ...
    **복구 진행 (2026-09-08): 08-03·08-10 완료. 08-17·08-24 남음.**
    ...
    남은 예산: 오늘 프로브 1 + 복구 14 = 15회, 밤 정기 실행 7회 → 22/25.
    **오늘은 더 못 돌린다.** 08-17·08-24는 내일.
